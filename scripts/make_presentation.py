...
Uses v6 reconstructions (geneo_ycbcr_v6 checkpoint, 100 epochs, all 3 GENEO layers).
...
TEST_IMAGES = [
    ("000000000036",
     MODEL_DIR / "images" / "000000000036.jpg",
     MODEL_DIR / "recon_000000000036.png"),
    ("000000000113",
     MODEL_DIR / "images" / "000000000113.jpg",
     MODEL_DIR / "recon_000000000113.png"),
    ("000000262235",
     MODEL_DIR / "images" / "000000262235.jpg",
     MODEL_DIR / "recon_000000262235.png"),
    ("000000525732",
     MODEL_DIR / "images" / "000000525732.jpg",
     MODEL_DIR / "recon_000000525732.png"),
]
...
def main():
    print("Building research presentation with v6 reconstructions...")

    results = []
    for stem, orig_path, recon_path in TEST_IMAGES:
    ...
    # ==================================================================
    # FIGURE 1: Main comparison (original | reconstruction)
    # ==================================================================
    n = len(results)
    ...
    plt.suptitle(
        ...
        "Reconstructing images from object detection embeddings (v6 decoder, 100 epochs)",
    ...
    left_sections = [
        ...
        ("Our Contribution",
         ...
         "\n"
         f"Decoder: v6, trained for 100 epochs on 908 COCO images,\n"
         f"all 3 GENEO layers (head13, head26, head52) trained.\n"
         f"Validation loss: 0.3415.\n"
         f"\n"
    ...
    # Summary
    print("\n" + "=" * 60)
    print("RESEARCH PRESENTATION GENERATED (v6)")
    print("=" * 60)
    ...
    print(f"Decoder:   v6 (100 epochs, 3 GENEO layers, val loss 0.3415)")
